...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            String match_day = Utilies.getMatchDay(cursor.getInt(COL_MATCHDAY),
                    cursor.getInt(COL_LEAGUE));
            match_day_view.setText(match_day);
            match_day_view.setContentDescription(match_day);
            ...
            share_button.setContentDescription(context.getResources().getString(R.string.share_button));
